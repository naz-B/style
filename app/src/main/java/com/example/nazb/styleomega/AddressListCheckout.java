...
public class AddressListCheckout extends ArrayAdapter<Address> {

    public AddressListCheckout(@NonNull Context context, @LayoutRes int resource, @NonNull List<Address> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(null == v) {
            ...
            v = inflater.inflate(R.layout.address_list_checkout, null);
        }
